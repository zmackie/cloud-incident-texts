...
url: "https://www.sumologic.com/solutions/security/response-center"
source_type: article
source_domain: www.sumologic.com
cleanup_method: llm
---
...
[Subscribe to RSS](https://www.sumologic.com/feed/security-response)

![Image 47: hero continuous intelligence platform hero](http://www.sumologic.com/wp-content/uploads/hero-continuous_intelligence_platform_hero.png)

![Image 48: main banner bg blur](https://sumo-wp-marketing-site-assets.s3.amazonaws.com/uploads/2024/10/main-banner-bg-blur.svg)
...
As we have done throughout this process, we encourage you to keep an eye on the[Security Response Center](https://www.sumologic.com/solutions/security/response-center)where we have posted pertinent updates. We also would like to provide you with additional tools and information.
...
STATUS UPDATE November 14, 2023 – 6:00PM PST+
...
If you have questions about steps to take, don’t hesitate to get in touch with our customer support team at[https://support.sumologic.com/support/s/](https://support.sumologic.com/support/s/)

STATUS UPDATE November 12, 2023 – 3:30PM PST+
...
STATUS UPDATE November 11, 2023 – 3:30PM PST+
...
Here is a direct link to the playbook:[link](https://help.sumologic.com/docs/manage/security/rotating-credentials-playbooks/)

_The information contained in this website is provided “as is,” without any warranty of any kind, either express or implied. Users are solely responsible for adequate protection and backup of the data and equipment used in connection herewith. If Users require assistance, please contact our Support team via opening a ticket using our Support Console._
...
*   Sumo Logic API access keys (If you need assistance with this, please contact Sumo Support at[https://support.sumologic.com/support/s/](https://support.sumologic.com/support/s/))
...
If you have questions about steps to take, please do not hesitate to contact our customer support team at[https://support.sumologic.com/support/s/](https://support.sumologic.com/support/s/)
...
libwebp Vulnerability October 26, 2023+

**October 26, 2023**

Last month Google published[CVE-2023-5129](https://www.cve.org/CVERecord?id=CVE-2023-5129)(marked as a duplicate) and[CVE-2023-4863](https://www.cve.org/CVERecord?id=CVE-2023-4863)indicating vulnerabilities existed within libwebp and as a result within a number of downstream applications leveraging it. Sumo Logic has updated all applicable systems to ensure we are not vulnerable and are continuing to monitor our corporate security posture as well as our third-party vendors to ensure they are dealing with the situation as appropriate.

HTTP/2 Rapid Reset Attack+

**October 26, 2023**

Sumo Logic is aware of the vulnerability[CVE-2023-44487](https://nvd.nist.gov/vuln/detail/CVE-2023-44487), also known as “HTTP/2 Rapid Reset Attack.” Sumo Logic has mitigations in place that we inherit from AWS mechanisms. We do not believe we are susceptible based on our scanning, testing, and inherited mitigations from our AWS-based infrastructure. We have followed the current[guidance published by AWS](https://aws.amazon.com/security/security-bulletins/AWS-2023-011/)in this regard.

libwebp Vulnerability September 28, 2023+
...
Sumo Logic is aware of the published vulnerabilities ([CVE-2023-34362](https://nvd.nist.gov/vuln/detail/CVE-2023-34362),[CVE-2023-35036](https://nvd.nist.gov/vuln/detail/CVE-2023-35036), and[CVE-2023-35708](https://nvd.nist.gov/vuln/detail/CVE-2023-35708)) by Progress software indicating that the MOVEit Transfer tool was vulnerable to multiple SQL injection vulnerabilities. Our investigation suggests that Sumo Logic is not impacted as our products and services do not use MOVEit Transfer tool. Our current assessment is that no action is required from our customers, but we will continue to monitor and update as appropriate.

OpenSSL Vulnerability+

**November 4, 2022**

Sumo Logic is aware of the recently announced OpenSSL vulnerabilities ([CVE-2022-3786](https://nvd.nist.gov/vuln/detail/CVE-2022-3786)and[CVE-2022-3602](https://nvd.nist.gov/vuln/detail/CVE-2022-3602)). Our initial investigation suggests that**Sumo Logic is not impacted**as our products and services do not rely on OpenSSL. Our current assessment is that no action is required from our customers, but we will continue to monitor and update as appropriate.

Spring4Shell April 1, 2022+

**April 1, 2022**

Sumo Logic has validated that we do not use any part of the vulnerable Spring Cloud framework found in[CVE-2022-22963](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-22963). We have also reviewed[CVE-2022-22965](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-22965)and have validated that Sumo Logic is not vulnerable to known exploitable methods. Out of an abundance of caution, we will be updating our Sumo Logic Service; however, no action is required on your part. The Sumo Logic collector is not vulnerable to known Spring Cloud framework exploitation methods.

Spring4Shell March 31, 2022+
...
[Sumo Logic blog: Okta evolving situation: Am I impacted?](https://www.sumologic.com/blog/okta-evolving-situation-am-i-impacted)

![Image 49: dashboard okta access compromised](http://www.sumologic.com/wp-content/uploads/dashboard-okta-access-compromised.png)

## Additional resources

[![Image 50: thumb linkedin live v2](https://www.sumologic.com/wp-content/uploads/thumb-linkedin-live-v2.jpg) video ### SEC Rules for Cybersecurity Disclosures Watch video](https://www.linkedin.com/events/7091843143762923520/about/)[![Image 51: thumb SEC passed new cybersecurity rules social v3](https://www.sumologic.com/wp-content/uploads/thumb-SEC-passed-new-cybersecurity-rules-social-v3.png) blog ### SEC rules on cybersecurity disclosure Read blog](https://www.sumologic.com/blog/sec-cybersecurity-disclosure-rules)[![Image 52: thumb specops min 1](https://www.sumologic.com/wp-content/uploads/thumb-specops-min-1.png) blog ### Okta evolving situation: Am I impacted? Read blog](https://www.sumologic.com/blog/okta-evolving-situation-am-i-impacted)[![Image 53: thumb sumo security analytics demo thumb 1](https://www.sumologic.com/wp-content/uploads/thumb-sumo-security-analytics-demo-thumb-1.jpg) Integration ### Okta Integration for Sumo Logic See integration](https://www.sumologic.com/app-catalog/okta)[![Image 54: thumb platform security thumb 1](https://www.sumologic.com/wp-content/uploads/thumb-platform-security-thumb-1.jpg) blog ### Mind your Single Sign-On (SSO) logs Read blog](https://www.sumologic.com/blog/mind-your-single-sign-on-sso-logs)[![Image 55: thumb Day in the life with Sumo Logic Cloud SIEM 1](https://www.sumologic.com/wp-content/uploads/thumb-Day-in-the-life-with-Sumo-Logic-Cloud-SIEM-1.png) Solution ### Log4j vulnerability response center Learn more](https://www.sumologic.com/solutions/security/log4j)[![Image 56: thumb esentire brief card v2](https://www.sumologic.com/wp-content/uploads/thumb-esentire-brief-card-v2.png) brief ### Strengthening the detection of software supply chain attacks Download brief](https://www.sumologic.com/briefs/strengthening-detection-of-software-supply-chain-attacks)
...
*   [SEC wants cyber-incident disclosure within four days](https://www.infosecurity-magazine.com/news/sec-cyberincident-disclosure-four/)
*   [Statement by President Biden on our Nation’s Cybersecurity](https://www.whitehouse.gov/briefing-room/statements-releases/2022/03/21/statement-by-president-biden-on-our-nations-cybersecurity/)
*   [Exclusive: Ransomware attacks on U.S. supply chain are undermining national security, CBP bulletin warns](https://news.yahoo.com/exclusive-ransomware-attacks-on-us-supply-chain-are-undermining-national-security-customs-and-border-protection-bulletin-warns-191403260.html)

## How can Sumo Logic help?

![Image 57: icon security 2 color](http://www.sumologic.com/wp-content/uploads/icon-security-2-color.svg)

**Actively monitoring current threats in real-time to ensure customers are not impacted**

![Image 58: icon manage 2 color icon](http://www.sumologic.com/wp-content/uploads/icon-manage-2-color-icon.svg)

**Creating easy-to-copy search queries and filters customers can use to determine if they are at risk**.

![Image 59: icon queries 2 color icon](http://www.sumologic.com/wp-content/uploads/icon-queries-2-color-icon.svg)
...
[Start free trial](https://www.sumologic.com/sign-up)

![Image 60: dashboard application monitoring 2](http://www.sumologic.com/wp-content/uploads/dashboard-application_monitoring-2.png)

![Image 61: dashboard Kubernetes monitoring 1](http://www.sumologic.com/wp-content/uploads/dashboard-Kubernetes_monitoring-1.png)
