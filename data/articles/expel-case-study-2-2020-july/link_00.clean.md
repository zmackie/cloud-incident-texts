...
url: "https://web.archive.org/web/20210128055101/https://expel.io/blog/behind-the-scenes-expel-soc-alert-aws/"
author: Sam Lipton, Lori Easterly, Anthony Randazzo, Jon Hencinski
...
- A full list of all EC2 instances spun up by the attacker with details on how to terminate them
- AWS security groups created by the attacker and how to remove them
- Checking in on the status of the compromised root access key
...
We’ll apply these lessons learned, continue to improve our ability to spot evil quickly in AWS and mature are response procedures.
